...
export async function main(): Promise<void> {
	...
	let _gs_ta_val_0c06: number
	let _gs_ta_ok_0c06: boolean
	({ value: _gs_ta_val_0c06, ok: _gs_ta_ok_0c06 } = $.typeAssert<number>(x, {kind: $.TypeKind.Basic, name: 'number'}))
	result.ok = _gs_ta_ok_0c06
