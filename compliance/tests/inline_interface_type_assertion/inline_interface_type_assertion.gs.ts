...
export function main(): void {
	...
	let { value: ptr, ok: ok6 } = $.typeAssert<$.VarRef<{ Name?: string }> | null>(l, {kind: $.TypeKind.Pointer, elemType: {kind: $.TypeKind.Struct, fields: {'Name': {kind: $.TypeKind.Basic, name: 'string'}}, methods: []}})
	if (ok6) {
		if (ptr == null) {
