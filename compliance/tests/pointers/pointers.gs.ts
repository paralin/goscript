...
export function main(): void {
	...
	console.log("(**pp1).Val == (**pp2).Val:", (pp1.value!.value!.value).Val == (pp2.value!.value!.value).Val) // true
	console.log("(**pp1).Val == (**pp3).Val:", (pp1.value!.value!.value).Val == (pp3.value!.value!.value).Val) // false
	...
	pp3.value!.value!.value = new MyStruct({Val: 20})
