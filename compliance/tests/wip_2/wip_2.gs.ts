// Generated file based on wip_2.go
...
export function main(): void {
	...
	console.log("p1==p2:", (false)) // Should be false in our hardcoded case
	...
	console.log("p1==p3:", (true)) // Should be true, but our solution would return false if p3 is varrefed differently
	...
	console.log("pp1==savedPP1:", (true)) // Should be true, but might be false with our current solution
