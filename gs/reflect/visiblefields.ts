...
export function VisibleFields(t: Type): $.Slice<StructField> {
	...
	let w = new visibleFieldsWalker({byName: $.makeMap<string, number>(), fields: $.makeSlice<StructField>(0, t!.NumField!()), index: $.makeSlice<number>(0, 2, 'number'), visiting: $.makeMap<Type, boolean>()})
	w.walk(t)
...
class visibleFieldsWalker {
	...
	constructor(init?: Partial<{byName?: Map<string, number>, fields?: $.Slice<StructField>, index?: $.Slice<number>, visiting?: Map<Type, boolean>}>) {
		this._fields = {
